...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            remember.setChecked(savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX));
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if (remember.isChecked()) {
            savedInstanceState.putBoolean(Constants.REMEMBER_ME_CHECKBOX, remember.isChecked());
